...
-- =============================================================================
-- DELTA_LOAD_USERINFOPAYROLLMAPPING
-- PK: DATABASEPHYSICALNAME + USERINFOPAYROLLMAPPINGID
...
--   $5  = UserInfoPayrollMappingID (NUMBER)
--   $6  = UserID                   (NUMBER)
--   $7  = PayrollClientID          (VARCHAR(36))
--   $8  = PayrollEmployeeID        (NUMBER)
--   $9  = StartDateTime            (TIMESTAMP_NTZ)
--   $10 = EndDateTime              (TIMESTAMP_NTZ)
--   $11 = ModifiedBy               (NUMBER)
--   $12 = ModifiedOn               (TIMESTAMP_NTZ)
--   $13 = EmployeeStatus           (NUMBER)
--   $14 = WEID                     (VARCHAR(100))
--   $15 = WorkerVersion            (NUMBER)
-- =============================================================================

CREATE OR REPLACE PROCEDURE DELTA_LOAD_USERINFOPAYROLLMAPPING(
    STAGE_NAME VARCHAR
)
RETURNS VARCHAR
LANGUAGE JAVASCRIPT
...
AS '
    ...
    try {
        ...
        var get_files_query = `
            ...
            WHERE table_id = ''f1b0a3f6-49a5-a942-2349-e2c4c7fb15fa''
