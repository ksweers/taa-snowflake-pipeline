...
CREATE OR REPLACE PROCEDURE DELTA_LOAD_TIMESLICEPOSTEXCEPTIONDETAIL(
    STAGE_NAME VARCHAR
)
RETURNS VARCHAR
LANGUAGE JAVASCRIPT
...
AS '
    ...
    try {
        ...
        var get_files_query = `
            ...
            WHERE table_id = ''be6c4966-d75e-ef52-7460-75c736afbf26''
...
-- =============================================================================
-- STG_DELTA_TIMESLICEPOSTSHIFTDIFFDETAIL
